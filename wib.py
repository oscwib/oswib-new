...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EotBTHjtubgCeTJsKgbf.TZjEI917pMDTTp1BY9K5+W.lC94YjGipUo/fbXspWUShEN9e2mMUDWNoiG4lv47d+o=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Eot9ck46jMY42qNqryvb.Fg2xAK8+c6My92znQ5+akW.Ltl/uwbRughN1TAYosjIkuAgskqFS0ZSF0yXJgfEkX0=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Eov8dkcjZWFkhopiSvO8.tSL6Ni+BpiVGFpzQ9Gu22a.9+u7yjQPHqyk6B/RmrYnfm7OBOzjiRf5qokP25dGO7s=') 
kk.loginResult() 
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EolAw2a5PxeIdMglRwx6.xuC8K6+gzJsmen91eTrSPG.6ycmLs9vWxingi5jLKeIjB1mNYcInTtQ4LJfsP7EGHw=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EozJURqUyVKmSoLrUdz4.CKP6GP5GmFyfYuKxouLRXa.0tzrsc1ALuZ8ZxDK3er6yHu1JVPXaAh5x43on1baA6k=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Eovwtj6spAiciGriqN7b.F3dwbSK4u10C9ILUzTcpQW.dq6YxdKvh95Bcpixai/iw4VXjhJUVXqz96KhAc4W71I=') 
km.loginResult()
...
Creator=["u4a361586c55ac4ef218a0a9b78b2f1b3","ub2c8650d1af85d5c66d1f8389072e3b2","u4fd239a77c16d1ea7853cd801f6c379d"]
admin=["u4a361586c55ac4ef218a0a9b78b2f1b3","ub7325e8bdd7b3e676db4fd5bcbd939ff","u4fd239a77c16d1ea7853cd801f6c379d","ud919c919e5d9c5ec30dff0d9bc58dde7","u4ec97a9c8fdb3c8be07cf66af60536d8","u5d473c93afc666348c10df7512d46ca6","u724a7a829e6031f605c9491739496bc4","u7f70d606c938535d1cf6296e66d08fab","u7c6d976a4f3f0ba998f7664dab9fc02b","ua4992b649803f4550c626f1133cd3096","ub2c8650d1af85d5c66d1f8389072e3b2"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin W⃟   I⃟   B⃟  Dihapus")
                        except:
                            pass
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Wib1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Wib2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Wib3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua Oswib  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "OSWIB,'"}
                cl.sendMessage(msg)

 
            elif "Oswib copy @" in msg.text:
                   print "[COPY] Ok"
            ...
            elif "@W⃟   I⃟   B⃟ " in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@W⃟   I⃟   B⃟ ")
                jawab = ("Jangan Tag Si W⃟   I⃟   B⃟ ...","Berisik Jangan Tag Si W⃟   I⃟   B⃟ ...,","Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dia Lagi Sibuk Jangan Tag W⃟   I⃟   B⃟ ","Woii Bicik Jangan Tag Lagi Gua Bilang!!!","W⃟   I⃟   B⃟, Lagi Off...\nKalau Penting PC Aja W⃟   I⃟   B⃟  nya")
